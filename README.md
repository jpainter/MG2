...
**Time range:** 60 months — 12 real months (Jan–Dec 2025) downloaded from the public [DHIS2 Sierra Leone demo instance](https://play.im.dhis2.org/stable-2-41-8/) plus 48 months of prior history generated by a seasonal bootstrap with four features designed to exercise the full MG2 pipeline:
...
- **Reporting completeness gaps** — earlier years have fewer facility-months present (~65% in 2021 rising to ~93% by 2024), so the Reporting tab shows a real completeness trend rather than flat 100%.
