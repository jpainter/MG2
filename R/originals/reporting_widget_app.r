        ...
        tabPanel(
          ...
          sidebarLayout(
            sidebarPanel(
              ...
              tabsetPanel(
                ...
                tabPanel(
                  ...
                  p(
                    'Find *Champion* facilities  -- the ones that reported the most each year during the selected period',
            ...
            "
                  ...
                  p(
                    "By default, facilities are counted as reporting if any of the selected data were reported.",
                    style = "font-size: 16px"
                  ),

                  p(
                    "For data elements that have low values and are often be zero, the zero value may not be recorded.  In those cases it is helpful to use other data elements as a marker to indicate that the facility likely reported.  For example, the number of deaths due to a specific disease may be missing, but if other deaths were reported, it may be reasonable to assume that the facility should be counted as having reported.",
                ...
                tabPanel(
                  ...
                  p(
                    "Datasets are the forms used to enter data",
                ...
                tabPanel(
                  ...
                  p(
                    'Filter Org Units (press update button to change display',
                    style = "font-size: 14px"
                  ),
    ...
    function(
      ...
      orgunit.reports = reactive({
        ...
        if (testing) {
          ...
          save(
            ...
            file = 'orgunits.reports.data.rda'
          )
        }
      ...
      observe({
        ...
        if (nrow(data1()) > 0 && 'level' %in% names(data1())) {
          ...
          ls = setDT(data1())[
            base::get(levelNames()[2]) %in% input$level2,
      ...
      n_selected = reactive({
        ...
        if (testing) {
          saveRDS(
            selected_data_categories$elements,
            "selected_data_categories.rds"
          )
        }
      ...
      champion_chart = reactive({
        ...
        if (testing) {
          saveRDS(champion_facilities(), "champion_facilities.rds")
        }
      ...
      output$champion_map <- renderLeaflet({
        champion_map()
      })
