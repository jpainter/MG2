...
tsmodels = function(
  ...
  # Prophet models require fable.prophet (heavy rstan/Stan dependency — optional).
  ...
  if (msg && .has_prophet && !.use_prophet)
  ...
  # Covariate types need rlang::inject() to substitute the covariate symbol (!!covariate)
