          ...
          sidebarLayout(
              ...
              tabsetPanel(
                tabPanel(
                  ...
                  inputPanel(
                    ...
                    checkboxInput(
                      ns("autoModel"),
                      label = 'Automatic nmodel selection',
                      value = FALSE
                    )
                  )
                ),
                ...
                tabPanel(
                  ...
                  checkboxInput(
                    ns('hts'),
                    label = "hts across full admin hierarchy",
                    value = FALSE
                  ),
                  ...
                  selectInput(
                    ns("agg_method"),
                    label = "Aggregate (regression) method:",
                ...
                tabPanel(
                  "Reporting",
                  h5(
                    "Choose whether or not to limit analysis to consistently reporting facilities.  
                  ...
                  checkboxInput(
                    ns("selected"),
                    label = 'Selected facilities only',
                    value = TRUE
                  )
                ),
                ...
                tabPanel(
                  ...
                  h5(
                    "Choose whether or not to remove potential outliers, as flagged in the Outliers page.  
            ...
            mainPanel(
              ...
              inputPanel(
                ...
                selectInput(
                  ns("horizon"),
                  label = "Number periods after intervention:",
  ...
  moduleServer(
    ...
    function(input, output, session) {
      ...
      tsModel = reactive({
        ...
        cat(
          '\n - ',
          paste('available vars:', paste(names(trend_Data), collapse = ','))
        )
          ...
          g = g +
            geom_label_repel(
              data = trend_Data %>%
                filter(
                  !!rlang::sym(.period) ==
                    max(trend_Data %>% pull(.period), na.rm = T)
                ),
